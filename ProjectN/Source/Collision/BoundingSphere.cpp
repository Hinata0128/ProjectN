...
BoundingSphere::BoundingSphere()
	...
	, m_Radius()
{
	m_pMesh = StaticMeshManager::GetInstance()->GetMeshInstance(StaticMeshManager::CMeshList::Collision);
}
...
//他の球体との当たり判定.
bool BoundingSphere::IsHit(const BoundingSphere& pBSphere)
{
	//2つの球体の中心の距離を求める.
	//参照しているとドット演算子になる.
...
void BoundingSphere::Draw(D3DXMATRIX& View, D3DXMATRIX& Proj, LIGHT& Light, CAMERA& Camera)
{
	//描画直前で座標や回転情報などを更新.
